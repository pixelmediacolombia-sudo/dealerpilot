...
test("Sales AI intake is owned by the Messenger AI extension and backend contract", () => {
  ...
  assert.match(conversationsSource, /down_payment_amount_received/);
  assert.match(conversationsSource, /concrete_cash_offer_received/);
  assert.match(conversationsSource, /The buyer provided a phone number/);
  ...
  assert.match(conversationsSource, /provide the complete store address directly and ask whether they would like to come see the vehicle and what day works/);
