...
const SPANISH_TOKENS = /\b(?:buenas|gracias|disponible|tengo|quiero|estoy|interesad[oa]s?|claro|podemos|ayuda|inicial|comprar|semana|numero|telefono|itin|ingresos|esta|esa|ese|eso|esto|este|es|son|tiene|tienen|precio|cuanto|cual|donde|cuando|carro|auto|vehiculo|si|como|necesit[ao]|aplicar|requisitos?|documentos?|pasaporte|cuenta|bancaria|financiar|financiamiento|asesor|opciones?|disponibles?|tambien|puedo|puedes?|mira|dime|informacion|diferencia|paquete|millas|kilometros?|garantia|motor|automatico|mecanico|manual|camioneta|sedan|historial|accidente|condicion|pido|ahora|listo|nuevo|viejo|gusta|encanta|necesitaria|estaria|alguno|alguna|otro|otra|mas|talvez|seguir|pago|pag[oó]|contado|efectivo|solo|enviamos|mandamos|ubicacion|direccion|cuatro|seis|cilindros)\b/g;
